...
hl.bind(super("SHIFT + P"), run(qsbar .. " media playPause"), locked)
hl.bind(super("SHIFT + N"), run(qsbar .. " media next"), locked)
hl.bind(super("SHIFT + B"), run(qsbar .. " media previous"), locked)
hl.bind("XF86AudioPlay", run(qsbar .. " media playPause"), locked)
hl.bind("XF86AudioPause", run(qsbar .. " media playPause"), locked)
hl.bind("XF86AudioNext", run(qsbar .. " media next"), locked)
hl.bind("XF86AudioPrev", run(qsbar .. " media previous"), locked)
